...
class AIMetricsDashboard:
    ...
    def display_dashboard(self):
        ...
        overall_success_rate = (total_success / total_reviews * 100) if total_reviews > 0 else 0
    ...
    def _display_insights(self):
        ...
        if best_agent:
            print(f"✨ Best Performer: {best_agent} ({best_success_rate:.1f}% success rate)")
        ...
        if total_reviews < 10:
            ...
            avg_iterations = sum(m["total_iterations"] for m in self.metrics.values()) / total_reviews
            if avg_iterations > 3:
    ...
    def export_report(self, output_file: str):
        ...
        with open(output_file, 'w') as f:
            ...
            f.write("## Summary\n\n")
            f.write("| Agent | Reviews | Success Rate | Avg Iterations | Avg Auto-fixes |\n")
            f.write("|-------|---------|--------------|----------------|----------------|\n")
            ...
            for agent_name, metrics in sorted(self.metrics.items()):
                if metrics["total_reviews"] > 0:
                    ...
                    f.write(f"| {agent_name} | {metrics['total_reviews']} | "
