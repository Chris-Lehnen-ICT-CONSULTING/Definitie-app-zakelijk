...
def fix_todo_placeholders(file_path: Path) -> int:
    ...
    replacements = [
        (r'TE_DOEN - File path to be determined', 'Nog te bepalen tijdens implementatie'),
        (r'TE_DOEN - Auth service not yet implemented', 'Authenticatie service nog te implementeren'),
