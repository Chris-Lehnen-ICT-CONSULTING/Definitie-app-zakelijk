...
- **Always place documentation in docs/ subdirectories, NEVER in the root**
- Use logical subdirectories:
  - `docs/analysis/` - for analysis documents
  - `docs/modules/` - for module-specific documentation
  - `docs/technical/` - for technical documentation
  - `docs/testing/` - for test-related documentation
  - `docs/archief/` - for archived documents
- Avoid creating documents in the root directory
- **IMPORTANT: CLAUDE.md must remain in the root directory - DO NOT move or delete this file**
- **CLAUDE.md should only be updated when adding project-specific instructions**
