---
id: US-051
titel: Fix CFR-BUG-014 Synoniemen/Antoniemen Generatie
epic: EPIC-010
status: Completed
prioriteit: KRITIEK
story_points: 5
...
- [x] Synoniemen prompts bevatten definitie + context
- [x] Antoniemen prompts bevatten definitie + context
- [x] Parser ondersteunt zowel newline als komma-gescheiden items
- [x] Retry logic: max 1 retry bij te weinig items
- [x] Op laatste poging: accepteer wat er is (voorkom infinite loops)
- [x] UI toont synoniemen/antoniemen ZONDER bullets
- [x] Andere voorbeeldtypes behouden bullets

### Technische Criteria
- [x] `unified_voorbeelden.py` aangepast met verbeterde prompts
- [x] `_parse_response()` methode met komma-fallback
- [x] `_generate_with_retry()` methode met max 1 retry
- [x] UI rendering logic aangepast voor type-specifieke formatting
- [x] max_tokens consistent (2000) voor sync en async

### Performance Criteria
- [x] Generatie tijd < 5 seconden per type
- [x] Retry voegt max 3 seconden toe
- [x] Minimaal 3 items gegenereerd (acceptabel minimum)
- [x] Ideaal 5 items gegenereerd (target)
...
- [x] Unit tests geschreven en groen
- [x] Integration tests groen
- [x] Verificatie script succesvol
- [x] Code review completed
- [x] UI test: synoniemen/antoniemen zonder bullets
- [x] Performance binnen targets
...
- ✅ Parser ondersteunt meerdere formaten (newline en komma-gescheiden)

### Test resultaten:
- Synoniemen: 5 items succesvol gegenereerd
- Antoniemen: 5 items succesvol gegenereerd
- Performance: 0.04s met caching (ruim binnen 5s target)
