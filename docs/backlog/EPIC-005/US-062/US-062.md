...
- Management-tab bevat een “Kleine batch CSV import (≤100)” workflow (`src/ui/components/management_tab.py:620`) die `DefinitionImportService` hergebruikt voor sequentiële import en rapportdownload.
