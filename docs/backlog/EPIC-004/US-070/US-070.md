...
# US-070: Normaliseer Wettelijke Basis naar eigen tabel(len) met rijke query-ondersteuning
...
## Context
- Huidig: `wettelijke_basis` is een JSON array in `definities` (zie [US‑069](../US-069/US-069.md)). Dat is voldoende voor weergeven/basale opslag, maar beperkt voor query’s en datakwaliteit.
...
- Gerelateerd: [US‑064](../US-064/US-064.md), [US‑069](../US-069/US-069.md), [EPIC‑004](../EPIC-004.md)
