...
id: US-155
epic: EPIC-004
titel: "US-155: - Dit bevestigt dat de status technisch bestaat, maar de UI moet een bewuste gebruikersactie bieden om van "In review..."
type: feature
...
- [x] Expert Review tab toont "Afwijzen" knop met verplicht reden‑veld
...
- [x] Voor definities met status "Vastgesteld" is er een actie "Maak bewerkbaar" (status terugzetten) met verplicht reden‑veld en logging
...
- [x] Alle UI‑labels in het Nederlands; DB‑statuscodes blijven ongewijzigd
- [x] Approval workflow met gate‑preview en override‑reden (via DefinitionWorkflowService)
