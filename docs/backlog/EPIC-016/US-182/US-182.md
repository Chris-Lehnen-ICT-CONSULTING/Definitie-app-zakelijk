...
id: US-182
epic: EPIC-016
titel: "US-182: Beheer van validatie‑gatebeleid bij Vaststellen: mode (hard/soft), drempels, forbidden severities, vereiste velden en..."
status: open
prioriteit: P2
story_points: 5
...
# US-182: Gate‑policy beheer (Approval Gate Policy)
...
## Testplan
- Unit: GatePolicyService laad/merge/ttl/invalidatie; validatie van payload (ranges/booleans/sets)
- Integratie: wijzig policy → workflow ziet nieuwe drempel/gate zonder restart
- UI: form validatie; diff‑samenvatting; audit entry geschreven
...
## Beveiliging
- Voor nu: feature‑flag/rolcheck; later integreren met auth (US‑187).
