...
class DutchLegalLexicon:
    ...
    def _load_complete_lexicons(self) -> Dict[str, Set[str]]:
        ...
        return {
            'strafrecht': {
                # Actoren (50 termen)
                'verdachte', 'dader', 'slachtoffer', 'getuige', 'medeverdachte',
                'medepleger', 'medeplichtige', 'uitlokker', 'benadeelde', 'aangever',
                'klager', 'veroordeelde', 'recidivist', 'first offender', 'jeugdige',
                'meerderjarige', 'minderjarige', 'toerekeningsvatbare', 'ontoerekeningsvatbare',
                'verdediging', 'advocaat', 'raadsman', 'officier van justitie', 'rechter',
                'rechter-commissaris', 'griffier', 'reclassering', 'jeugdbescherming',
                'kinderbescherming', 'voogd', 'curator', 'bewindvoerder', 'mentor',

                # Handelingen & Procedures (60 termen)
                'aangifte', 'aanhouding', 'arrestatie', 'fouillering', 'doorzoeking',
                'inbeslagname', 'verhoor', 'ondervraging', 'confrontatie', 'schouw',
                'inverzekeringstelling', 'voorgeleiding', 'bewaring', 'gevangenhouding',
                'voorlopige hechtenis', 'schorsing', 'dagvaarding', 'oproeping',
                'betekening', 'kennisgeving', 'zitting', 'behandeling', 'pleidooi',
                'requisitoir', 'strafeis', 'verweer', 'repliek', 'dupliek',
                'beraadslaging', 'uitspraak', 'vonnis', 'arrest', 'veroordeling',
                'vrijspraak', 'ontslag van rechtsvervolging', 'schuldigverklaring',
                'straf', 'maatregel', 'gevangenisstraf', 'hechtenis', 'taakstraf',
                'geldboete', 'voorwaardelijke straf', 'proeftijd', 'bijzondere voorwaarden',
                'hoger beroep', 'cassatie', 'verzet', 'herziening', 'gratie',
                'strafonderbreking', 'strafuitstel', 'vervroegde invrijheidstelling',
                'voorwaardelijke invrijheidstelling', 'elektronisch toezicht',

                # Documenten & Besluiten (40 termen)
                'proces-verbaal', 'strafdossier', 'procesdossier', 'kennisgeving van inbeslagneming',
                'bevel tot inverzekeringstelling', 'bevel tot bewaring', 'bevel tot gevangenhouding',
                'vordering', 'beschikking', 'beslissing', 'strafbeschikking', 'transactie',
                'sepot', 'seponering', 'dagvaarding', 'tenlastelegging', 'akte',
                'verklaring', 'bekentenis', 'ontkenning', 'getuigenverklaring',
                'deskundigenrapport', 'reclasseringsrapport', 'uittreksel justitiële documentatie',
                'verklaring omtrent gedrag', 'strafblad', 'documentatie', 'dossier'
            },

            'bestuursrecht': {
                # Actoren (40 termen)
                'burger', 'inwoner', 'belanghebbende', 'derde-belanghebbende', 'aanvrager',
                'vergunninghouder', 'bezwaarmaker', 'appellant', 'verweerder', 'gemachtigde',
                'bestuursorgaan', 'bevoegd gezag', 'college', 'burgemeester', 'wethouders',
                'gedeputeerde staten', 'commissaris van de koning', 'minister', 'staatssecretaris',
                'ambtenaar', 'inspecteur', 'controleur', 'handhaver', 'toezichthouder',
                'adviseur', 'commissie', 'adviescommissie', 'bezwaarcommissie', 'klachtencommissie',
                'ombudsman', 'bestuursrechter', 'voorzieningenrechter', 'hoger beroepsrechter',

                # Handelingen & Procedures (50 termen)
                'aanvraag', 'verzoek', 'melding', 'kennisgeving', 'zienswijze',
                'inspraak', 'consultatie', 'advies', 'voorbereiding', 'onderzoek',
                'besluitvorming', 'beschikking', 'besluit', 'vaststelling', 'goedkeuring',
                'weigering', 'intrekking', 'wijziging', 'verlenging', 'publicatie',
                'bekendmaking', 'mededeling', 'ter inzage legging', 'terinzagelegging',
                'bezwaar', 'bezwaarprocedure', 'hoorzitting', 'heroverweging', 'heroverwegingsbesluit',
                'administratief beroep', 'beroep', 'hoger beroep', 'voorlopige voorziening',
                'schorsing', 'vernietiging', 'handhaving', 'sanctie', 'bestuursdwang',
                'dwangsom', 'last onder dwangsom', 'last onder bestuursdwang', 'waarschuwing',
                'herstelmaatregel', 'gedogen', 'legalisatie', 'toezicht', 'controle',

                # Documenten & Instrumenten (30 termen)
                'vergunning', 'ontheffing', 'vrijstelling', 'concessie', 'subsidie',
                'beschikking', 'beleidsregel', 'algemeen verbindend voorschrift', 'verordening',
                'regeling', 'nadere regels', 'uitvoeringsregels', 'mandaat', 'delegatie',
                'attributie', 'convenant', 'bestuursovereenkomst', 'bestemmingsplan',
                'omgevingsplan', 'omgevingsvergunning', 'milieuvergunning', 'bouwvergunning',
                'gebruiksvergunning', 'exploitatievergunning', 'evenementenvergunning',
                'standplaatsvergunning', 'ventvergunning', 'onttrekkingsvergunning'
            },

            'civiel_recht': {
                # Partijen & Relaties (40 termen)
                'koper', 'verkoper', 'huurder', 'verhuurder', 'pachter', 'verpachter',
                'schuldenaar', 'schuldeiser', 'crediteur', 'debiteur', 'opdrachtgever',
                'opdrachtnemer', 'aannemer', 'onderaannemer', 'werkgever', 'werknemer',
                'vennoot', 'aandeelhouder', 'bestuurder', 'commissaris', 'curator',
                'bewindvoerder', 'executeur', 'erfgenaam', 'legataris', 'erflater',
                'schenker', 'begiftigde', 'bruiklener', 'bruikleengever', 'bewaarnemer',
                'bewaargever', 'borg', 'hoofdelijk schuldenaar', 'pandgever', 'pandhouder',
                'hypotheekgever', 'hypotheekhouder', 'vruchtgebruiker', 'hoofdgerechtigde',

                # Overeenkomsten & Rechtshandelingen (40 termen)
                'koopovereenkomst', 'huurovereenkomst', 'pachtovereenkomst', 'arbeidsovereenkomst',
                'aanneemovereenkomst', 'opdracht', 'lastgeving', 'bemiddeling', 'agentuur',
                'distributieovereenkomst', 'franchiseovereenkomst', 'licentieovereenkomst',
                'leaseovereenkomst', 'bruikleenovereenkomst', 'bewaargeving', 'borgstelling',
                'schenking', 'ruiling', 'dading', 'vaststellingsovereenkomst', 'cessie',
                'subrogatie', 'novatie', 'delegatie', 'schuldvernieuwing', 'kwijtschelding',
                'verrekening', 'opzegging', 'ontbinding', 'nietigheid', 'vernietiging',
                'bekrachtiging', 'conversie', 'dwaling', 'bedrog', 'misbruik van omstandigheden',
                'bedreiging', 'onbekwaamheid', 'wilsgebrek', 'toestemming',

                # Goederen & Rechten (20 termen)
                'eigendom', 'bezit', 'houderschap', 'vruchtgebruik', 'erfpacht',
                'opstal', 'erfdienstbaarheid', 'pand', 'hypotheek', 'beslag',
                'retentierecht', 'voorrecht', 'zekerheidsrecht', 'goederenrecht',
                'zaak', 'roerende zaak', 'onroerende zaak', 'registergoed',
                'vermogensrecht', 'vorderingsrecht'
            },

            'algemeen_juridisch': {
                # Rechtspersonen & Organisaties (40 termen)
                'rechtspersoon', 'natuurlijk persoon', 'publiekrechtelijke rechtspersoon',
                'privaatrechtelijke rechtspersoon', 'vennootschap', 'bv', 'nv', 'vof',
                'cv', 'maatschap', 'coöperatie', 'onderlinge waarborgmaatschappij',
                'vereniging', 'stichting', 'kerkgenootschap', 'overheidsorgaan',
                'zelfstandig bestuursorgaan', 'openbaar lichaam', 'gemeente', 'provincie',
                'waterschap', 'rijk', 'staat', 'ministerie', 'dienst', 'agentschap',
                'inspectie', 'autoriteit', 'raad', 'commissie', 'rechtbank', 'gerechtshof',
                'hoge raad', 'centrale raad van beroep', 'raad van state',
                'college van beroep voor het bedrijfsleven', 'accountantskamer',
                'notariskamer', 'medisch tuchtcollege', 'tuchtcollege',

                # Algemene Juridische Concepten (50 termen)
                'recht', 'plicht', 'bevoegdheid', 'aanspraak', 'rechtsverhouding',
                'rechtsfeit', 'rechtshandeling', 'rechtsgevolg', 'rechtssubject',
                'rechtsobject', 'rechtsregel', 'rechtsnorm', 'rechtsbeginsel',
                'rechtszekerheid', 'rechtsgelijkheid', 'rechtvaardigheid', 'redelijkheid',
                'billijkheid', 'proportionaliteit', 'subsidiariteit', 'zorgvuldigheid',
                'motivering', 'belangenafweging', 'discretionaire bevoegdheid',
                'gebonden bevoegdheid', 'beleidsvrijheid', 'beoordelingsruimte',
                'toetsing', 'rechtmatigheid', 'onrechtmatigheid', 'nietigheid',
                'vernietigbaarheid', 'verjaring', 'stuiting', 'schorsing', 'verval',
                'afstand', 'rechtsverwerking', 'vertrouwensbeginsel', 'gelijkheidsbeginsel',
                'zorgvuldigheidsbeginsel', 'motiveringsbeginsel', 'rechtszekerheidsbeginsel',
                'evenredigheidsbeginsel', 'verbod van détournement de pouvoir',
                'verbod van willekeur', 'hoor en wederhoor', 'openbaarheid',

                # Procedures & Documenten (40 termen)
                'procedure', 'proces', 'geding', 'instantie', 'aanleg', 'termijn',
                'beroepstermijn', 'bezwaartermijn', 'vervaltermijn', 'fatale termijn',
                'verjaringstermijn', 'redelijke termijn', 'proceshandeling', 'processtuk',
                'dossier', 'akte', 'authentieke akte', 'onderhandse akte', 'notariële akte',
                'grosse', 'executoriale titel', 'dwangbevel', 'exploot', 'dagvaarding',
                'verzoekschrift', 'beroepschrift', 'bezwaarschrift', 'klaagschrift',
                'conclusie', 'memorie', 'pleitnota', 'productie', 'bewijs', 'bewijslast',
                'bewijsmiddel', 'schriftelijk bewijs', 'getuigenbewijs', 'deskundigenbericht',
                'vermoeden', 'bekentenis', 'eed', 'verklaring'
            }
        }
...
class PatternMatcher:
    ...
    def _initialize_all_patterns(self) -> Dict[str, Dict[str, Any]]:
        ...
        return {
            UFOCategory.KIND: {
                ...
                'keywords': {
                    'persoon', 'mens', 'individu', 'organisatie', 'bedrijf',
                    'instelling', 'zaak', 'ding', 'object', 'entiteit',
                    'document', 'gebouw', 'voertuig', 'systeem', 'apparaat'
                },
                'weight': 1.0
            },
            ...
            UFOCategory.EVENT: {
                ...
                'keywords': {
                    'arrestatie', 'aanhouding', 'zitting', 'procedure', 'proces',
                    'behandeling', 'onderzoek', 'verhoor', 'uitspraak', 'vonnis',
                    'gebeurtenis', 'handeling', 'actie', 'operatie', 'transactie'
                },
                'weight': 0.9
            },
            ...
            UFOCategory.ROLE: {
                ...
                'keywords': {
                    'verdachte', 'dader', 'slachtoffer', 'getuige', 'rechter',
                    'officier', 'advocaat', 'notaris', 'deurwaarder', 'curator',
                    'eigenaar', 'gebruiker', 'bewoner', 'bestuurder', 'aandeelhouder'
                },
                'weight': 0.8
            },
            ...
            UFOCategory.PHASE: {
                ...
                'keywords': {
                    'onderzoek', 'voorlopig', 'definitief', 'concept', 'ontwerp',
                    'actief', 'inactief', 'lopend', 'afgerond', 'gesloten',
                    'nieuw', 'oud', 'huidig', 'voormalig', 'toekomstig'
                },
                'weight': 0.7
            },
            ...
            UFOCategory.RELATOR: {
                ...
                'keywords': {
                    'overeenkomst', 'contract', 'huwelijk', 'verbintenis', 'relatie',
                    'vergunning', 'mandaat', 'volmacht', 'licentie', 'concessie',
                    'dagvaarding', 'beschikking', 'vonnis', 'arrest', 'uitspraak'
                },
                'weight': 0.8
            },
            ...
            UFOCategory.MODE: {
                ...
                'keywords': {
                    ...
                    'gemoedstoestand', 'geestestoestand', 'lichamelijke toestand',
                    'vermogen', 'inkomen', 'bezit', 'eigenschap', 'kwaliteit'
                },
                'weight': 0.6
            },
            ...
            UFOCategory.QUANTITY: {
                ...
                'keywords': {
                    'bedrag', 'aantal', 'hoeveelheid', 'percentage', 'tarief',
                    'prijs', 'kosten', 'omzet', 'winst', 'verlies',
                    'afstand', 'oppervlakte', 'inhoud', 'gewicht', 'duur'
                },
                'weight': 0.7
            },
            ...
            UFOCategory.QUALITY: {
                ...
                'keywords': {
                    ...
                    'complexiteit', 'moeilijkheidsgraad', 'urgentie', 'prioriteit',
                    'belangrijkheid', 'relevantie', 'geschiktheid', 'toepasbaarheid'
                },
                'weight': 0.6
            },
            ...
            UFOCategory.SUBKIND: {
                ...
                'keywords': {
                    'subtype', 'subcategorie', 'deelgroep', 'variant', 'vorm',
                    'soort', 'type', 'klasse', 'categorie', 'groep'
                },
                'weight': 0.5
            },
            ...
            UFOCategory.CATEGORY: {
                ...
                'keywords': {
                    'categorie', 'klasse', 'groep', 'verzameling', 'collectie',
                    'type', 'soort', 'classificatie', 'indeling', 'rubricering'
                },
                'weight': 0.5
            },
            ...
            UFOCategory.MIXIN: {
                ...
                'keywords': {
                    'gemeenschappelijk', 'gedeeld', 'gezamenlijk', 'collectief',
                    'algemeen', 'universeel', 'generiek', 'abstract'
                },
                'weight': 0.4
            },
            ...
            UFOCategory.ROLEMIXIN: {
                ...
                'keywords': {
                    'rolpatroon', 'functiepatroon', 'gedragspatroon', 'rolmodel'
                },
                'weight': 0.4
            },
            ...
            UFOCategory.PHASEMIXIN: {
                ...
                'keywords': {
                    'fasepatroon', 'stadiumpatroon', 'levenscycluspatroon'
                },
                'weight': 0.4
            },
            ...
            UFOCategory.COLLECTIVE: {
                ...
                'keywords': {
                    'groep', 'team', 'commissie', 'raad', 'college',
                    'vereniging', 'collectief', 'gemeenschap', 'samenwerking',
                    'consortium', 'alliantie', 'coalitie', 'federatie'
                },
                'weight': 0.6
            },
            ...
            UFOCategory.VARIABLECOLLECTION: {
                ...
                'keywords': {
                    'dynamisch', 'variabel', 'flexibel', 'wisselend', 'veranderlijk'
                },
                'weight': 0.5
            },
            ...
            UFOCategory.FIXEDCOLLECTION: {
                ...
                'keywords': {
                    'vast', 'bepaald', 'gefixeerd', 'statisch', 'permanent',
                    'onveranderlijk', 'definitief'
                },
                'weight': 0.5
            }
        }
    ...
    def _initialize_disambiguation(self) -> Dict[str, List[Tuple[str, UFOCategory]]]:
        ...
        return {
            'zaak': [
                ...
                (r'de\s+zaak\s+van\s+(?:verdachte|eisende partij)', UFOCategory.ABSTRACT)
            ],

            'huwelijk': [
                (r'(?:sluiten|voltrekken|aangaan)\s+(?:van\s+)?(?:een\s+)?huwelijk', UFOCategory.EVENT),
                (r'huwelijks(?:voltrekking|sluiting|ceremonie)', UFOCategory.EVENT),
                (r'(?:staat|band|verbintenis)\s+van\s+het\s+huwelijk', UFOCategory.RELATOR),
                (r'huwelijk\s+tussen', UFOCategory.RELATOR),
                (r'gehuwd\s+(?:zijn|paar|stel)', UFOCategory.RELATOR)
            ],

            'overeenkomst': [
                (r'(?:sluiten|aangaan|tekenen)\s+(?:van\s+)?(?:een\s+)?overeenkomst', UFOCategory.EVENT),
            ...
            'procedure': [
                (r'(?:start|begin|aanvang)\s+(?:van\s+)?(?:de\s+)?procedure', UFOCategory.EVENT),
            ...
            'vergunning': [
                (r'(?:aanvragen|verlenen|verstrekken)\s+(?:van\s+)?(?:een\s+)?vergunning', UFOCategory.EVENT),
            ...
            'besluit': [
                ...
                (r'besluit\s+(?:van|door)\s+(?:het\s+)?(?:bestuur|rechter)', UFOCategory.RELATOR),
    ...
    def apply_disambiguation(self, term: str, definition: str) -> Optional[Tuple[UFOCategory, str]]:
        """
...
class UFOClassifierService:
    ...
    def __init__(self, config_path: Optional[Path] = None):
        ...
        logger.info(f"Geladen: {len(self.pattern_matcher.lexicon.get_all_terms())} juridische termen")
    ...
    def _apply_complete_9_step_logic(
        ...
        decision_path.append("Geen specifieke categorie gedetecteerd, fallback naar Kind")
        return UFOCategory.KIND
    ...
    def _mediates_relationship(self, text: str, matches: Dict) -> bool:
        ...
        indicators = [
            ...
            'huwelijk' in text and not 'sluiten' in text,
    ...
    def _calculate_all_scores(
        ...
        for category in UFOCategory:
            ...
            if 'mogelijk' in definition.lower() or 'waarschijnlijk' in definition.lower():
                base_score *= 0.9
    ...
    def _is_relevant_for_domain(self, category: UFOCategory, domain: str) -> bool:
        ...
        domain_relevance = {
            ...
            'algemeen_juridisch': [UFOCategory.KIND, UFOCategory.CATEGORY, UFOCategory.MIXIN]
        }
    ...
    def _generate_detailed_explanation(
        ...
        # Header
        explanations.append(
            f"=== UFO Classificatie Analyse voor '{result.term}' ==="
        )
        ...
        legal_matches = self.pattern_matcher.lexicon.find_matching_terms(result.definition)
        if legal_matches:
    ...
    def batch_classify(
        ...
        for i, (term, definition) in enumerate(definitions, 1):
            try:
                ...
                error_result.detailed_explanation = [f"FOUT: {str(e)}"]
...
if __name__ == "__main__":
    ...
    test_cases = [
        ("verdachte", "Persoon die wordt verdacht van het plegen van een strafbaar feit"),
        ("arrestatie", "Het aanhouden van een persoon door de politie"),
        ("koopovereenkomst", "Overeenkomst waarbij de verkoper zich verbindt een zaak te geven"),
        ("eigendom", "Het meest omvattende recht dat een persoon op een zaak kan hebben"),
        ("rechtszaak", "Procedure voor de rechter waarbij partijen hun geschil voorleggen"),
