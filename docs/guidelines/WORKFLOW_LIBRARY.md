...
Doel: meerdere, doelgerichte workflows naast de bestaande TDD→Deployment creëren, zodat we niet elke opdracht door hetzelfde zware pad sturen. Dit document beschrijft de beschikbare workflows, hun fasen, agents, en wanneer je welke inzet.
...
- Exit: story is READY FOR DEV, geen tests/code vereist.
...
- User stories: docs/stories/MASTER-EPICS-USER-STORIES.md
