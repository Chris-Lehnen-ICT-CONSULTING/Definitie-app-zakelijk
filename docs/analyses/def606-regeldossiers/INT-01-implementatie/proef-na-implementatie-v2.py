"""DEF-770 ronde 2: offline proef na verwerking van de Codex-reviewbevindingen.
...
Aanroep vanuit de repositorywortel:
    <python> -B docs/analyses/.../proef-na-implementatie-v2.py <uitvoerpad.json>
"""
...
werk = offline_bootstrap.session_root() / "int01-na-implementatie-v2"
werk.mkdir()
...
def _exportbeeld(pad: Path, did: int) -> dict:
    ...
    return {
        "json": json_rij,
        "csv_gelijk_aan_json": csv_cel == json_rij,
...
async def main() -> int:
    ...
    opslag = _opslagproef()
    rapport = {
        "basis": "26f2374d302fc66fc0b12ed29dc34585f7c0a5c3 + niet-gecommitte DEF-770-diff (ronde 2)",
        "python": sys.version,
