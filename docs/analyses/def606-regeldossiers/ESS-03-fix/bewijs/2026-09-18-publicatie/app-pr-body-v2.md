...
Aanvullend zijn vier echte generaties uitgevoerd via de bestaande PromptServiceV2/AIServiceV2 en het geconfigureerde model (claude-opus-4-8), zonder cache of retries: eiland, water als stof, watermonster en fysiek boekexemplaar. Geen identifierplicht toegevoegd en geen stof-naar-monster-verschuiving waargenomen; alle vier kandidaten keren terug als scoreloze open ESS-03-beoordeling. De formulering over plaatsing bij het boekexemplaar vraagt nog inhoudelijke beoordeling. Prompt-hashes, ruwe uitvoer en service-uitkomsten zijn bewaard en gecontroleerd. Deze kleine synthetische steekproef is geen statistisch kwaliteitsbewijs.
