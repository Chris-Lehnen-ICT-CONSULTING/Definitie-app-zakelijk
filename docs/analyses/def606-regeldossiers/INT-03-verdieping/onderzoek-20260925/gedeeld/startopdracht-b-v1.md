# Startopdracht onderzoeker B — INT-03 — 25 september 2026

Je bent onderzoeker B in een afzonderlijke sessie (Codex CLI, GPT-6 Astra, reasoning high volgens ~/.codex/config.toml). Onderzoeker A (Claude in Cowork) coördineert en doet parallel een eigen onderzoek; onderzoeker C (Claude Code CLI) werkt eveneens parallel en onafhankelijk. Antwoord en schrijf uitsluitend in het Nederlands.
...
- één casusregister met stabiele IDs (prefix INT03-B-E, historische IDs niet hernummeren), per geval verwachting voor G/T/H vóór uitvoering;
