# Startopdracht onderzoeker {ROL} — INT-03 — 25 september 2026

Je bent onderzoeker {ROL} in een afzonderlijke sessie ({UITVOERDER}). Onderzoeker A (Claude in Cowork) coördineert en doet parallel een eigen onderzoek; onderzoeker {ANDER} werkt eveneens parallel en onafhankelijk. Antwoord en schrijf uitsluitend in het Nederlands.
...
- één casusregister met stabiele IDs (prefix INT03-{ROL}-E, historische IDs niet hernummeren), per geval verwachting voor G/T/H vóór uitvoering;
