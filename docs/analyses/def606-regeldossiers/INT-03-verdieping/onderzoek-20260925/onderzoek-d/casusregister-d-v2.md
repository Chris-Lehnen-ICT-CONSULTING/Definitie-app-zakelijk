# Casusregister onderzoeker D — INT-03 — v2

25 september 2026. Zelfstandige ontwerpverwachtingen, vastgelegd vóór uitvoering. Normvoorstel N-D1 is geen vastgesteld beleid. [Machineleesbare invoer en verwachtingen](proefverwachtingen-d-v2.json).

Versiecorrectie na de serviceproef en vóór enige G/H-uitvoering: alleen de herstelverwachting van E04 is aangescherpt om de expliciete tijdsrelatie niet weg te schrijven. Alle oorspronkelijke verwachtingen en mislukte eerste start blijven in v1 bewaard. De actuele nulmeting staat in proefuitkomsten-d-v2.json (20 service-uitkomsten en 4 promptvarianten, exit 0). De nulmeting toetst v1 van de verwachtingen; de G/H-aanscherping verandert geen gemeten verwachting.

## Gebruik en bewijsgrens

Elke casus geldt voor dezelfde tekst als aangeleverde én gegenereerde kandidaat. Uitsluitend toetsen verandert niets; G/H mogen alleen een afzonderlijk voorstel geven. Alleen E01–E10 worden in de huidige service uitgevoerd, via manager en cache. E11–E18 zijn ontwerpgevallen. Geen G-/H-modeluitvoer, menselijke gebruikersproef of juridische praktijkvalidatie. Uitkomsten worden afzonderlijk in [proefuitkomsten-d-v2.json](proefuitkomsten-d-v2.json) bewaard; dit register blijft vooraf vastgelegd.
...
- G: Maak besluit expliciet met behoud van de tijdsrelatie, bijvoorbeeld: Verslag over een besluit nadat dat besluit is vastgesteld. Laat bij onduidelijke temporele aansluiting eerst de bedoeling bevestigen.

- T: voldoet niet: het laat verslag/besluit open.

- H: Vervang het door dat besluit bij bevestigde bedoeling; schrap nadat niet. Beoordeel of de tijdsrelatie bij het opstellen van het verslag hoort; bij twijfel stop en verduidelijk.
