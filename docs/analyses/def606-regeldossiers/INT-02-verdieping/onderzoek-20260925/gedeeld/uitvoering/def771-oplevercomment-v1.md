# Implementatieoplevering INT-02 — 26 september 2026

App: [PR #483](https://github.com/Chris-Lehnen-ICT-CONSULTING/Definitie-app-zakelijk/pull/483). Skills: [PR #358](https://github.com/ChrisLehnen/claude-global-setup/pull/358). Beide zijn concept-PR’s; niet gemerged. Dit actualiseert de historische tekst “implementatie niet gestart” in de issuebeschrijving.
...
## Acceptatiecriteria DEF-771

De zes bestaande onderzoekscriteria blijven ongewijzigd. Het samengestelde implementatiecriterium blijft open: gerichte acceptatie, onafhankelijke review en controle van actieve versies zijn uitgevoerd, maar actieve uitrol en volledige UI-/opslag-/vaststel-/exportdoorloop zijn nog niet bewezen. Geen automatische afvinking of nieuwe Done-claim.

- [x] B1–B6 vertaald naar beheerde contracten, exacte G en O1/S1; geen poort/herstel toegevoegd.
- [x] Offline pakkettests RED→GREEN, 55 definitieve DEF-771-tests en C1 36/36.
- [x] Onafhankelijke Codex CLI-review en gerichte R1-correctiereview afgerond.
- [x] Volledige suite uitgevoerd; alle 67 failures afzonderlijk verklaard en ook op basis aangetoond. De suite blijft rood.
- [x] Actieve skillversies gecontroleerd; beheerde bron/kopie/bundels gecontroleerd.
- [x] O2 na afzonderlijk akkoord geregistreerd als DEF-835.
- [ ] Actieve skilluitrol en volledige ketenverificatie.

Vervolg: [DEF-831](https://linear.app/definitie-app/issue/DEF-831), inclusief CON-01-keuze; [DEF-832](https://linear.app/definitie-app/issue/DEF-832); [DEF-835](https://linear.app/definitie-app/issue/DEF-835). DEF-626, DEF-830 en echte effectmeting blijven buiten deze levering.
