# ESS-04 — geïntegreerde besluitnotitie

18 september 2026. Onderzoeksvoorstel voor Chris; nog geen normbesluit of uitvoeringsopdracht. Beide onderzoeken, beide kruisreviews en beide verwerkingen zijn bewaard en gelezen. Cowork heeft de synthese gecontroleerd en besluitrijp als onderzoeksvoorstel beoordeeld, met concrete correcties. Die zijn verwerkt; zie synthesecontrole-verwerking-v1.md. Geen gebruikerskeuze is daarmee genomen.
...
De huidige UI-code toont de open reviewreden direct alleen voor ESS-01/02. Sluit ESS-04 aan op de bestaande passagehulp én op die zichtbare UI-route. Ruim de achtergebleven heuristische passverklaring en cijfergerichte herstelhint op bij uitvoering; de onderzochte runtime bereikt die teksten nu niet. Dit is een concrete codebevinding en voorstel, geen uitgevoerde UI-test.
...
| Q2 context/bron/ontologie/aanvullingen; dossier4–7 | Geïntegreerde veldmatrix in veldrollen-en-keten-v2.md; cases en tekstenv5 |
| Q3 samenhang; dossier12 | Relaties in Q3 van beide onderzoeken; ESS-03-bron en regellokale poortafbakening hierboven |
| Q4 gedrag/score/poort/proeven; dossier8/10/11 | Bewijsregisterv3 en voorafverwachting/scripts/logs |
| Q5 instructies; dossier9 | Exact N2/G2/T2/H2, meldingen, vijf skillfamilies in tekstvoorstelv5 |
...
[Coworks synthesecontrole](cowork-uitwisseling/cowork-synthesecontrole-v1.md) controleerde negen hashgebonden stukken, alle37 scenario’s en beide standpunten. [Zichtbare verwerking](synthesecontrole-verwerking-v1.md) sluit de vijf punten; de [eindverificatie](eindverificatie-v1.json) controleert bronbinding, oorspronkelijke versies, casusverwijzingen en lokale links. Hashcontrole bewijst documentintegriteit, geen productwerking. Het volledige Codex-onderzoek staat in [de eerste bijdrage](codex-onderzoek-v1.md), gelezen met [de reviewverwerking](codex-reviewverwerking-v1.md); de notitie en actuele bijlagen hierboven zijn het herziene advies.
