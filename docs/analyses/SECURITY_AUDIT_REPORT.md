...
**Example:**
```
Secret: sk-proj-***REMOVED-DEF-491***... (truncated)
File: config/config_development.yaml
Commit: REDACTED-DEF522
...
**Examples:**
- `cache_key": "REDACTED-DEF522"` (example cache key in documentation)
...
echo "Git history key pattern: sk-proj-***REMOVED-DEF-491***..."
...
config/config_development.yaml:openai_api_key:REDACTED-DEF522
docs/portal/rendered/analyses/CONFIG_ENVIRONMENT_MASTERPLAN.html:openai-api-key-new-format:REDACTED-DEF522
docs/portal/rendered/analyses/CONFIG_ENVIRONMENT_VERIFICATION_REPORT.html:generic-api-key:REDACTED-DEF522

# False positives (example code)
docs/portal/rendered/architectuur/structured-logging-architecture.html:generic-api-key:REDACTED-DEF522
EOF
