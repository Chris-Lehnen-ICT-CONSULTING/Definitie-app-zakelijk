...
id: US-050
epic: EPIC-CFR
title: Create End-to-End Context FLAAG Tests
canonical: true
...
story_points: 5
sprint: sprint-37
Afhankelijkheden: ["US-041", "US-042", "US-043", "US-048", "US-049"]
aangemaakt: 2025-09-05
bijgewerkt: 2025-09-05
assigned_to: qa-team
vereisten: ["REQ-068", "REQ-069", "REQ-076"]
---
...
**wil ik** comprehensive end-to-end tests for the entire context fLAAG
**zodat** we can prevent regressions en ensure justice compliance

## Acceptatiecriteria

### Criterion 1: Happy Path Testing
...
- **OM Scenarios**: openbaar ministerie context workfLAAGs
...
- **Cross-Chain**: Inter-organization workfLAAGs
...
class ContextFLAAGE2ETests(TestCase):
    """End-to-end tests for context fLAAG"""
    ...
    def test_om_openbaar ministerie_context_fLAAG(self):
        """Test OM-specific context fLAAG"""
        # Arrange
        context_data = {
            'juridische_context': ['Strafrecht', 'Strafvordering'],
            'organisatorische_context': ['OM - Openbaar Ministerie'],
        ...
        self.assertIn("openbaar ministerie", response.definition.LAAGer())

    def test_dji_detentie_context_fLAAG(self):
        """Test DJI detentie management context"""
        # Implementatie...

    def test_rechtspraak_rechtbank_context_fLAAG(self):
...
class ContextFLAAGPrestatiesTests(LoadTestCase):
    """Prestaties tests for context fLAAG"""
...
edge_cases:
  ...
  special_characters:
    - description: "Special chars in custom context"
      ...
      expected: "Sanitized en valiDatumd"
  ...
  Eners_option:
    - description: "Custom 'Eners...' option"
      ...
      expected: "Custom text valiDatumd en accepted"
```
...
class JusticeTestDataFactory:
    ...
    def create_om_context():
        """Create OM openbaar ministerie context"""
        return {
            'juridische_context': ['Strafrecht', 'Strafvordering'],
            'organisatorische_context': ['OM - Openbaar Ministerie'],
    ...
    def create_dji_context():
        ...
        return {
            ...
            'organisatorische_context': ['DJI - Dienst Justitiële Inrichtingen'],
...
- Error scenarios: > 90%
- Edge cases: > 85%
- Prestaties scenarios: Core workfLAAGs
- Justice partner scenarios: All KRITIEK paths

## Definitie van Gereed

- [ ] Test framework setup complete
- [ ] All happy path tests implemented
...
- All context fLAAG stories Voltooid (US-041 through US-049)
...
- [Justice Test Scenario's](../testing/justice_scenarios.md)
- [Prestaties Baselines](../testing/Prestaties_baselines.md)
