...
**Datum:** 2025-07-14  
**Totaal Bugs:** 15 (3 Critical, 9 Urgent, 3 Important)  
**Legacy Features Missing:** 20+ (4 Critical feature sets)

## Severity Levels
- **P0 (Critical)**: Blokkeert core functionaliteit
- **P1 (Urgent)**: Major feature broken
- **P2 (Important)**: Quality/UX issue
...
### **6. UI Regression - Term Input Hidden** ⏱️ *2 uur*
- **Status**: ❌ **WORKFLOW BREEKT**
- **File**: `src/ui/tabbed_interface.py`
- **Error**: Term input alleen zichtbaar binnen tab, niet op hoofdniveau
- **Impact**: Gebruiker moet eerst navigeren om basis functionaliteit te bereiken
- **Fix**: Herstel term input + basis context selectie op hoofdpagina
- **Test**: Visuele inspectie hoofdpagina workflow

### **7. UI Context Selector Complexity** ⏱️ *4 uur*
- **Status**: ❌ **UX PROBLEEM**
- **File**: `src/ui/components/context_selector.py`
- **Error**: Preset-based selectie verwarrend voor nieuwe gebruikers
- **Impact**: Verhoogde learning curve, gebruikers verward
- **Fix**: Directe multiselects als default, presets als advanced optie
- **Test**: User acceptance testing met nieuwe gebruikers

### **8. Missing Metadata Fields** ⏱️ *2 uur*
- **Status**: ❌ **FUNCTIONALITEIT VERLIES**
- **Files**: `src/ui/components/definition_generator_tab.py`
- **Error**: Datum voorstel, voorsteller, ketenpartners velden ontbreken
- **Impact**: Incomplete metadata voor definities
- **Fix**: Velden toevoegen aan definitie generator interface
- **Test**: Controleer alle metadata wordt opgeslagen in database

### **9. Resilience Utilities Import Error** ⏱️ *2 uur*
...
## 🔴 **LEGACY FEATURES - Missing Functionality**

### **10. AI Content Generation Missing** ⏱️ *1 week*
- **Status**: ❌ **KRITIEK FUNCTIEVERLIES**
- **Missing**: Voorbeeldzinnen, praktijkvoorbeelden, tegenvoorbeelden, toelichting, synoniemen/antoniemen
- **Impact**: Definities missen essentiële context en bruikbaarheid
- **Fix**: Implementeer `src/generation/content_enrichment.py`
- **Test**: Alle content types genereren voor test definitie

### **11. Custom Definition Tab Missing** ⏱️ *3 dagen*
- **Status**: ❌ **WORKFLOW BREEKT**
- **Missing**: Complete handmatige editing workflow, voorkeursterm selectie
- **Impact**: Geen mogelijkheid tot definitie aanpassing
- **Fix**: Create `src/ui/components/custom_definition_tab.py`
- **Test**: Edit en save custom definition met audit trail

### **12. Developer Tools Missing** ⏱️ *3 dagen*
- **Status**: ❌ **DEV WORKFLOW BEPERKT**
- **Missing**: Verboden woorden beheer, test tools, log controls, CSV download
- **Impact**: Ontwikkelaars kunnen niet effectief debuggen/testen
- **Fix**: Create `src/ui/components/developer_tools_tab.py`
- **Test**: Alle dev tools functioneel

### **13. AI Sources & Prompt Viewer Missing** ⏱️ *1 dag*
- **Status**: ❌ **TRANSPARANTIE VERLIES**
- **Missing**: Bronnen weergave, prompt viewer, copy functionaliteit
- **Impact**: Gebruikers zien niet hoe definitie tot stand komt
- **Fix**: Extend definition_generator_tab.py met expanders
- **Test**: Sources en prompt zichtbaar en kopieerbaar
