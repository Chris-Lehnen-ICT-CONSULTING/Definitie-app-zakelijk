...
│   │   │   ├── definition_generator_tab.py   # Main generation
│   │   │   ├── custom_definition_tab.py      # Manual editing (NEW)
│   │   │   ├── content_generation_tab.py     # AI content (NEW)
│   │   │   ├── developer_tools_tab.py        # Dev tools (NEW)
│   │   │   ├── expert_review_tab.py          # Expert review
│   │   │   ├── history_tab.py                # History view
│   │   │   └── export_tab.py                 # Export options
│   │   │   ├── molecules/          # Composite components
...
│   ├── content_generation/         # AI Content Generation Domain (NEW)
│   │   ├── entities/               # ContentType, GeneratedContent
│   │   ├── services/               # ContentEnrichmentService
│   │   ├── generators/             # VoorbeeldGenerator, SynoniemGenerator
│   │   └── prompts/                # Content-specific prompts
