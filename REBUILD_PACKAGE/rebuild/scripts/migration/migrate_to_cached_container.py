            ...
            if match:
                ...
                if other_imports.strip() and other_imports.strip()[0] == ",":
                    ...
                    if parts:
                        ...
                        imports_list = [
                            i for i in imports_list if i and "get_container" not in i
                        ]
                        if imports_list:
...
def main():
    ...
    for file_path in python_files:
        try:
            ...
            elif "get_container" in file_path.read_text():
    ...
    if migrated_files:
        ...
        print(
            "  3. Commit met: git commit -m 'fix(US-201): migrate to cached container'"
        )
    else:
