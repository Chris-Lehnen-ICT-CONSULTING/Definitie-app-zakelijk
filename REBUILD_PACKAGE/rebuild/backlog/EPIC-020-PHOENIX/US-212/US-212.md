...
titel: Import Definitions from CSV/JSON
type: feature
status: proposed
prioriteit: MEDIUM
story_points: 8
...
Deze story bouwt voort op US-062 uit EPIC-005 die de basis bulk import functionaliteit definieert. Voor de Phoenix rebuild moet deze functionaliteit volledig geïmplementeerd worden met robuuste validatie, conflict resolution, en transactionele integriteit.
...
│  Format: [CSV v] Delimiter: [, v]  │
│  Conflict: [Skip existing v]       │
...
- Alle acceptance criteria van US-062 worden geïmplementeerd
