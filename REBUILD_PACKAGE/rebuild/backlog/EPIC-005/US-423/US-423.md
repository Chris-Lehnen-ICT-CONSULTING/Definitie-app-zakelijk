...
id: US-423
epic: EPIC-005
titel: Background Export Queue Management
type: feature
status: proposed
prioriteit: LOW
story_points: 8
...
- [ ] Export queue service geïmplementeerd
...
```
┌─────────────────────────────────────────┐
│ 📊 Export Queue (2 active, 1 pending)   │
├─────────────────────────────────────────┤
│                                         │
│ ┌─────────────────────────────────┐    │
│ │ All definitions Q1 2025          │    │
│ │ ▓▓▓▓▓▓▓▓▓░░░░░░░░ 65%           │    │
│ │ Status: Running | ETA: 14:32     │    │
│ │                    [❌ Cancel]    │    │
│ └─────────────────────────────────┘    │
│                                         │
│ ┌─────────────────────────────────┐    │
│ │ Established only - Excel         │    │
│ │ ▓▓▓░░░░░░░░░░░░░ 23%            │    │
│ │ Status: Running | ETA: 14:45     │    │
│ │                    [❌ Cancel]    │    │
│ └─────────────────────────────────┘    │
│                                         │
│ ┌─────────────────────────────────┐    │
