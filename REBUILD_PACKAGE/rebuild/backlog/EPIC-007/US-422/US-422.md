...
id: US-422
epic: EPIC-007
titel: Advanced Duplicate Detection with ML
type: feature
status: proposed
prioriteit: LOW
story_points: 13
...
- [ ] ML duplicate detection service geïmplementeerd
...
│                                         │
│ ┌─────────────────────────────────┐    │
│ │ Cluster 1 (95% confidence)      │    │
│ ├─────────────────────────────────┤    │
│ │ ⚡ "Authenticatie" (DJI)         │    │
│ │ ⚡ "Authentificatie" (OM)        │    │
│ │    → Spelling variation detected │    │
│ │                                  │    │
│ │ [👁️ Preview Merge] [✅ Merge]   │    │
│ └─────────────────────────────────┘    │
│                                         │
│ ┌─────────────────────────────────┐    │
│ │ Cluster 2 (87% confidence)      │    │
│ ├─────────────────────────────────┤    │
│ │ 📄 "Vonnis" (Strafrecht)         │    │
│ │ 📄 "Uitspraak" (Strafrecht)      │    │
│ │    → Semantic similarity         │    │
│ │                                  │    │
│ │ [👁️ Preview] [➕ Whitelist]     │    │
│ └─────────────────────────────────┘    │
│                                         │
│ [⬇️ Export Report] [⚙️ Settings]       │
└─────────────────────────────────────────┘
```