...
class VER03Validator:
    ...
    def validate(self, definitie: str, begrip: str, context: Optional[Dict] = None) -> Tuple[bool, str, float]:
        ...
        return True, f"✔️ {self.id}: geen specifieke data of tijdstippen in definitie", 1.0
    ...
    def get_generation_hints(self) -> List[str]:
        ...
        hints.append("Bijvoorbeeld: gebruik 'sinds inwerkingtreding' ipv 'sinds 1 januari 2023'")
