...
class UIConfig:
    ...
    # Context options
    organizational_contexts: List[str] = field(default_factory=lambda: [
        "OM", "ZM", "Reclassering", "DJI", "NP", "Justid", "KMAR", 
        "FIOD", "CJIB", "Strafrechtketen", "Migratieketen", 
        "Justitie en Veiligheid", "Anders..."
    ])
    
    legal_contexts: List[str] = field(default_factory=lambda: [
        "Strafrecht", "Civiel recht", "Bestuursrecht", 
        "Internationaal recht", "Anders..."
    ])
    
    ketenpartners: List[str] = field(default_factory=lambda: [
        "ZM", "DJI", "KMAR", "CJIB", "JUSTID", "OM", "Politie", 
...
class ValidationConfig:
    ...
    allowed_toetsregels: List[str] = field(default_factory=lambda: [
        "CON-01", "CON-02", "ESS-01", "ESS-02", "ESS-04", "ESS-05",
        ...
        "ARAI01", "ARAI02", "ARAI02SUB1", "ARAI02SUB2", "ARAI03", 
        "ARAI04", "ARAI04SUB1", "ARAI05", "ARAI06"
    ])
...
class MonitoringConfig:
    ...
    openai_pricing: Dict[str, float] = field(default_factory=lambda: {
        "gpt-4": 0.03,
...
class ConfigManager:
    ...
    def __init__(self, environment: Environment = Environment.DEVELOPMENT, config_dir: str = "config"):
