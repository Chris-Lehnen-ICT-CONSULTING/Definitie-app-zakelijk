...
class DocumentProcessor:
    ...
    def process_uploaded_file(self, file_content: bytes, filename: str, mime_type: Optional[str] = None) -> ProcessedDocument:
        """
        ...
        try:
            ...
            if extracted_text is None:
                ...
                context_hints = self._generate_context_hints(extracted_text, keywords, key_concepts)
    ...
    def get_aggregated_context(self, selected_doc_ids: Optional[List[str]] = None) -> Dict[str, Any]:
        """
    ...
    def _extract_keywords(self, text: str) -> List[str]:
        ...
        stopwords = {
            'de', 'het', 'een', 'van', 'en', 'in', 'op', 'met', 'voor', 'door', 'aan', 'bij', 'naar', 'uit',
            'om', 'over', 'onder', 'tussen', 'tegen', 'tot', 'als', 'dat', 'die', 'dit', 'deze', 'zijn',
            'wordt', 'worden', 'is', 'was', 'waren', 'heeft', 'hebben', 'had', 'kan', 'moet', 'zal'
        }
    ...
    def _generate_context_hints(self, text: str, keywords: List[str], concepts: List[str]) -> List[str]:
        ...
        if any(word in ['wet', 'wetgeving', 'artikel', 'juridisch'] for word in keywords):
    ...
    def _load_metadata(self):
        ...
        if self.metadata_file.exists():
            try:
                ...
                logger.info(f"Metadata geladen voor {len(self._documents_cache)} documenten")
            except Exception as e:
