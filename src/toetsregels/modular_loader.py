...
class ModularToetsregelLoader:
    ...
    def load_regel(self, regel_id: str) -> Dict[str, Any]:
        ...
        if not json_path.exists():
            logger.warning(f"JSON configuratie niet gevonden voor {regel_id}: {json_path}")
            return None
    ...
    def _create_fallback_validator(self, config: Dict[str, Any]) -> Callable:
        ...
        def fallback_validate(definitie: str, begrip: str, context: Optional[Dict] = None) -> Tuple[bool, str, float]:
    ...
    def validate_with_regel(self, regel_id: str, definitie: str, begrip: str, 
...
def validate_met_regel(regel_id: str, definitie: str, begrip: str, 
                      context: Optional[Dict] = None) -> Tuple[bool, str, float]:
    """Valideer met een specifieke regel."""
    return get_modular_loader().validate_with_regel(regel_id, definitie, begrip, context)