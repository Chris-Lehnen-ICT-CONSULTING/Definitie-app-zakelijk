...
class INT08Validator:
    ...
    def validate(self, definitie: str, begrip: str, context: Optional[Dict] = None) -> Tuple[bool, str, float]:
        ...
        if not disallowed:
            ...
            if uitleg_aanwezig:
                return True, f"✅ {self.id}: geen negatieve formuleringen en komt overeen met goed voorbeeld", 1.0
            return True, f"✅ {self.id}: definitie bevat geen negatieve formuleringen", 1.0
