...
class INT06Validator:
    ...
    def validate(self, definitie: str, begrip: str, context: Optional[Dict] = None) -> Tuple[bool, str, float]:
        ...
        return True, f"✔️ {self.id}: geen toelichtende elementen in de definitie gevonden", 1.0
    ...
    def get_generation_hints(self) -> List[str]:
        ...
        hints.append("Vermijd toelichtende woorden zoals 'bijvoorbeeld', 'zoals', 'namelijk'")
        hints.append("Geef alleen de afbakening van het begrip, geen extra uitleg")
        hints.append("Voorbeelden en toelichting horen in een aparte notitie, niet in de definitie")
