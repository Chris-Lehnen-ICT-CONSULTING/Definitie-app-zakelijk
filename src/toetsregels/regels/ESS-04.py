...
class ESS04Validator:
    ...
    def get_generation_hints(self) -> List[str]:
        ...
        hints.append("Vermijd vage formuleringen zoals 'zo snel mogelijk', 'zo veel mogelijk'")
        hints.append("Gebruik concrete deadlines: 'binnen 3 dagen', 'uiterlijk na 1 week'")
