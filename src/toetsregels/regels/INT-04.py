...
class INT04Validator:
    ...
    def validate(self, definitie: str, begrip: str, context: Optional[Dict] = None) -> Tuple[bool, str, float]:
        ...
        if not hits:
            return True, f"✔️ {self.id}: geen onduidelijke lidwoord-verwijzingen aangetroffen", 1.0
    ...
    def get_generation_hints(self) -> List[str]:
        ...
        hints.append("Bij gebruik van 'de' of 'het', specificeer direct welke instelling/systeem bedoeld wordt")
        hints.append("Bijvoorbeeld: 'de instelling (Raad voor de Rechtspraak)' ipv alleen 'de instelling'")
        hints.append("Of gebruik onbepaalde lidwoorden: 'een instelling' ipv 'de instelling'")
