...
class ARAI03Validator:
    ...
    def __init__(self, config: dict):
        ...
        Args:
            config: Dictionary met configuratie uit ARAI03.json
        """
        self.config = config
        self.id = config.get("id", "ARAI03")
...
def create_validator(config_path: str | None = None) -> ARAI03Validator:
    """
