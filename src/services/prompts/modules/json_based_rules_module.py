    ...
    def _get_instruction_for_rule(self, regel_key: str) -> str | None:
        ...
        instruction_map = {
            ...
            "ESS-03": (
                ...
                "ESS-03-beoordeling (uitkomst onvoldoende informatie, met één "
                "gerichte vraag). Spreken bronnen of context "
            ...
            "INT-01": (
                ...
                "eindvoorwaarde als kenmerk in plaats van haar weg te laten, laat "
                ...
                "begrip niet afbakenen niet op. Is geen doelgroep "
