...
class ExportService:
    ...
    def _export_to_json(self, export_data: DefinitieExportData) -> str:
        ...
        json_data = {
            ...
            "technisch": {
                ...
                "created_at": export_data.created_at.isoformat() if export_data.created_at else None,
                "updated_at": export_data.updated_at.isoformat() if export_data.updated_at else None,
            }
        }
    ...
    def _export_to_csv(self, export_data: DefinitieExportData) -> str:
        ...
        # CSV velden
        fieldnames = [
            "begrip", "definitie_origineel", "definitie_gecorrigeerd",
            "definitie_aangepast", "status", "categorie", "domein",
            "voorkeursterm", "synoniemen", "antoniemen", "toelichting",
            "expert_review", "created_at", "updated_at"
        ]
        ...
        with open(pad, "w", newline="", encoding="utf-8") as csvfile:
            ...
            row = {
                ...
                "toelichting": export_data.toelichting,
                "expert_review": export_data.expert_review,
                "created_at": export_data.created_at.isoformat() if export_data.created_at else "",
                "updated_at": export_data.updated_at.isoformat() if export_data.updated_at else "",
            }
    ...
    def get_export_history(self, begrip: Optional[str] = None) -> list[dict[str, Any]]:
        """
