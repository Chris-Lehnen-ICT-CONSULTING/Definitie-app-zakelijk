...
class JSONValidatorLoader:
    ...
    def __init__(self, regels_dir: Optional[str] = None):
        ...
        logger.info(f"JSONValidatorLoader geïnitialiseerd met directory: {self.regels_dir}")
    ...
    def load_validator(self, regel_id: str) -> Optional[Any]:
        ...
        try:
            ...
            spec = importlib.util.spec_from_file_location(f"toetsregel_{regel_id}", py_path)
