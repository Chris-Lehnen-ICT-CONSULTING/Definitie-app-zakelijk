...
class AsyncExampleGenerator:
    ...
    async def generate_all_examples(
        ...
        # Create all tasks
        tasks = {
            'voorbeeld_zinnen': self._generate_voorbeeld_zinnen(begrip, definitie, context_dict),
            'praktijkvoorbeelden': self._generate_praktijkvoorbeelden(begrip, definitie, context_dict),
            'tegenvoorbeelden': self._generate_tegenvoorbeelden(begrip, definitie, context_dict),
...
async def async_genereer_praktijkvoorbeelden(
    ...
    """Generate practice examples asynchronously."""
    generator = get_async_generator()
    return await generator._generate_praktijkvoorbeelden(begrip, definitie, context_dict)
