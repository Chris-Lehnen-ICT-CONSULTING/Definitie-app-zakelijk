...
def render_validation_detailed_list(
    ...
    *,
    ...
    # DEF-746/DEF-750/DEF-766/DEF-767: de open reden van ESS-01 t/m ESS-04 is
    ...
    # beoordeling zelf en haar opslag volgen in C/D (DEF-624/626/627).
    for review_item in validation_result.get("review_required") or []:
        ...
        if rule_id in ("ESS-01", "ESS-02", "ESS-03", "ESS-04"):
