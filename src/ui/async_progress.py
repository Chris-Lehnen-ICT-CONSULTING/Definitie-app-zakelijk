                ...
                with col3:
                    if result.examples:
                        improvement = max(
                            0,
                            100
                            - (result.processing_time / (result.total_requests * 3))
                            * 100,
                        )
