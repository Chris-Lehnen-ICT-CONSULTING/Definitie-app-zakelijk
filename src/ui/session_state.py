    ...
    def get_export_data() -> Dict[str, Any]:
        ...
        return {
            ...
            "metadata": {
                ...
                "datum_voorstel": st.session_state.get("datum_voorstel"),
                "voorgesteld_door": st.session_state.get("voorgesteld_door", ""),
                "ketenpartners": st.session_state.get("ketenpartners", [])
            },
