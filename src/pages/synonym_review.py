...
# Add src to path for imports (pages is now in src/)
...
# Generate section (NO expander to avoid nesting issues with suggestion cards below)
st.markdown("## 🚀 Genereer Nieuwe Synoniemen")
