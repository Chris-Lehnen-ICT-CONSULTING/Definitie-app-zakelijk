...
def test_backward_compatibility():
    ...
    result = toets_definitie(
        definitie="Een handeling waarbij iets wordt vastgelegd", toetsregels={}
    )
...
def test_validation_context():
    ...
    context = ValidationContext(definitie="Test definitie", begrip="test")
...
def test_validation_output():
    ...
    output = ValidationOutput(
        rule_id="TEST-01", result=ValidationResult.PASS, message="Test passed"
    )
