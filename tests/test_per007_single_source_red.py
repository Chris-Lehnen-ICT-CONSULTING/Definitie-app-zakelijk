...
class TestSingleSourceOfTruth:
    ...
    def test_prompt_context_legacy_path_blocked(self):
        ...
        assert len(legacy_methods) == 0, \
            f"Legacy methods still exist: {legacy_methods}"
    ...
    def test_no_direct_context_string_processing(self):
        ...
        assert len(string_processors) == 0, \
                    ...
                    if file.endswith(".py"):
                        ...
                        try:
                            with open(filepath, "r", encoding="utf-8") as f:
                                ...
                                if "_build_context" in content or \
                                   "_parse_context" in content or \
                                   "EnrichedContext(" in content:
