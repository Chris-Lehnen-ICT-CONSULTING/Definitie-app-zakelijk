...
class TestAndersOption:
    ...
    def test_anders_in_organisatorische_context(self):
        ...
        assert "Anders..." not in context["organisatorisch"], \
    ...
    def test_anders_preserves_order(self):
        ...
        assert context["organisatorisch"] == expected, \
    ...
    def test_anders_with_multiple_custom_entries(self):
        ...
        request = GenerationRequest(
            begrip="test",
            juridische_context=["Strafrecht", "Anders...", "CustomDomain1",
                              "Bestuursrecht", "Anders...", "CustomDomain2"]
        )
        ...
        assert context["juridisch"] == expected, \
    ...
    def test_anders_preserves_session_state(self):
        ...
        request = GenerationRequest(
            begrip="test",
            organisatorische_context=["OM", "Anders...", custom_org]
        )
        ...
        assert custom_org in st.session_state.get('custom_organisations', []), \
    ...
    def test_anders_deduplication(self):
        ...
        assert context["organisatorisch"] == ["OM", "DJI"], \
    ...
    def test_anders_in_all_three_context_types(self):
        ...
        assert "CustomJur" in context["juridisch"], \
            "Custom juridisch not preserved"
        assert "CustomWet" in context["wettelijk"], \
            "Custom wettelijk not preserved"
        ...
        assert "Anders..." not in all_values, \
            "Anders... marker still present in output"
    ...
    def test_anders_with_special_characters(self):
        ...
        context = manager._build_base_context(request)
        assert "Org-with-dashes & symbols!" in context["organisatorisch"], \
    ...
    def test_anders_validation_warnings(self):
        ...
        request = GenerationRequest(
            begrip="test",
            organisatorische_context=["OM", "Anders...", "NonASTRAOrg"]
        )
        ...
        with patch('logging.Logger.info') as mock_info:
            ...
            mock_info.assert_called_with(
                "Custom organization via Anders: NonASTRAOrg"
            )
