...
class TestPER007DocumentationCompliance:
    ...
    def test_per007_coverage_in_solution_architecture(self):
        ...
        assert "context_flow" in content.lower(), "Missing context_flow implementation details"
    ...
    def test_per007_adr_references(self):
        ...
        adr_locations = [
            self.BASE_DIR / "docs" / "architectuur" / "beslissingen" / "ADR-PER-007-presentation-data-separation.md",
            self.BASE_DIR / "docs" / "archief" / "ADR-PER-007-presentation-data-separation.md"
        ]
        ...
        if not adr_exists:
            ...
            assert "ADR" in content or "Architecture Decision" in content, \
    ...
    def test_per007_compliance_report_exists(self):
        ...
        assert report_exists, "PER-007 compliance report not found in expected locations"
    ...
    def test_per007_workflows_documented(self):
        ...
        found_workflows = sum(1 for keyword in workflow_keywords
                             if keyword.lower() in sa_content.lower())

        assert found_workflows >= 2, \
    ...
    def test_per007_migration_status_documented(self):
        ...
        for doc_path in docs_to_check:
            ...
            if any(keyword in content.lower() for keyword in
                   ["implemented", "complete", "status", "progress", "migrated"]):
                status_found = True
                break
    ...
    def test_per007_backwards_compatibility_noted(self):
        ...
        found_keywords = sum(1 for keyword in compatibility_keywords
    ...
    def test_per007_configuration_documented(self):
        ...
        config_found = sum(1 for indicator in config_indicators
                          if indicator.lower() in content.lower())

        assert config_found >= 2, \
