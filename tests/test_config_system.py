...
class TestConfigManager:
    ...
    def test_configuration_validation(self):
        ...
        with pytest.raises(ValueError):
            config_manager.set_config(ConfigSection.API, 'default_temperature', 'invalid')
...
class TestConfigurationPersistence:
    ...
    def test_configuration_saving(self):
        ...
        config_manager.set_config(ConfigSection.API, 'default_temperature', original_temp)
...
class TestConfigurationIntegration:
    ...
    def test_environment_configuration_isolation(self):
        ...
        try:
            ...
            assert dev_api_config.default_temperature != prod_api_config.default_temperature
