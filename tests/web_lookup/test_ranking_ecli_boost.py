...
def test_ecli_boost_in_contract_mapping():
    ...
    r1 = LookupResult(
        term="t",
        source=WebSource(name="Rechtspraak.nl", url="https://rechtspraak.nl/case", confidence=0.8, is_juridical=True),
    ...
    r2 = LookupResult(
        term="t",
        source=WebSource(name="Rechtspraak.nl", url="https://rechtspraak.nl/case2", confidence=0.8, is_juridical=True),
