...
from src.services.interfaces import DefinitionResponse, Definition
...
async def test_overall_score_param(adapter_with_orchestrator, score_present, score_value, expected):
    adapter, orchestrator = adapter_with_orchestrator
    orchestrator.create_definition.return_value = _def_response(score_present, score_value)
