...
def test_ensure_schema_compliance_adds_correlation_id_when_missing():
    ...
    out = ensure_schema_compliance(
        raw, correlation_id="00000000-0000-0000-0000-000000000000"
    )
...
def test_create_degraded_result_schema_conform():
    ...
    d = create_degraded_result(
        error="boom", correlation_id="00000000-0000-0000-0000-000000000001"
    )
    assert d["version"]
    ...
    assert d["improvement_suggestions"][0]["type"] in {
        "restructure",
        "rewrite",
        "addition",
        "removal",
...
def test_ensure_schema_compliance_on_invalid_type_yields_degraded():
    ...
    out = ensure_schema_compliance(
        object(), correlation_id="00000000-0000-0000-0000-000000000002"
    )
