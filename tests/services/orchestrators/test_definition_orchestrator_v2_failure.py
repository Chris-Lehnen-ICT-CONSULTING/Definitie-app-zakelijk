...
async def test_orchestrator_failure_flow_with_enhancement_and_feedback():
    ...
    cleaning_service.clean_text.return_value = CleaningResult(
        original_text="Een gegenereerde definitie.", cleaned_text="Een gegenereerde definitie.", was_cleaned=False
    )
    ...
    enhancement_service.enhance_definition.return_value = "Verbeterde definitie (maar nog onvoldoende)"
