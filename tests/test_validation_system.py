...
class TestInputValidator:
    ...
    def test_length_validation(self):
        ...
        # Test valid length
        result = self.validator.validate_text("Valid length", min_length=5, max_length=20)
        assert result.is_valid is True
    ...
    def test_definition_validation(self):
        ...
        valid_definition = "Een definitie is een verklaring van de betekenis van een woord of begrip."
...
class TestContentSanitizer:
    ...
    def test_sanitization_levels(self):
        ...
        strict_sanitized = self.sanitizer.sanitize_content(
            test_input, 
            level="strict"
        )
    ...
    def test_whitelist_sanitization(self):
        ...
        test_input = "<p>Hello <b>world</b>!</p><script>alert('xss')</script><div>Content</div>"
...
class TestValidationIntegration:
    ...
    def test_validation_performance(self):
        ...
        assert result.is_valid is True or result.is_valid is False  # Should return result
