...
class SessionStateManager:
    ...
    def get_context_dict() -> Dict[str, List[str]]:
        ...
        return {
            "organisatorisch": st.session_state.get("context", []),  # Organisatorische context
            "juridisch": st.session_state.get("juridische_context", []),  # Juridische context
    ...
    def get_export_data() -> Dict[str, Any]:
        ...
        return {
            ...
            "voorbeeld_zinnen": st.session_state.get("voorbeeld_zinnen", []),  # Voorbeeldzinnen
            "praktijkvoorbeelden": st.session_state.get("praktijkvoorbeelden", []),  # Praktijkvoorbeelden
            "tegenvoorbeelden": st.session_state.get("tegenvoorbeelden", []),  # Tegenvoorbeelden
            "toelichting": st.session_state.get("toelichting", ""),  # Uitgebreide toelichting
