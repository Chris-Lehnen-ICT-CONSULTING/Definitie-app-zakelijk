...
agent:
  ...
  icon: 📊
  whenToUse: Gebruik voor marktonderzoek, brainstorming, concurrentieanalyse, project briefs maken, initiële project ontdekking, en documenteren van bestaande projecten (brownfield)
  customization:
    language: Nederlands
